...
type Pelanggan struct {
	...
	KodePelanggan     string        `gorm:"type:varchar(50);unique;not null" json:"kode_pelanggan"`
	...
	NamaPelanggan     string        `gorm:"type:varchar(150);not null" json:"nama_pelanggan"`
	...
	BkPembantuPiutang bool          `gorm:"default:false" json:"bk_pembantu_piutang"`
